...
(function() {
    ...
    function processMeetingData(jsonData, date) {
        ...
        var date1, date2, todayMeetings, dElemList, tempStartTime, tempEndTime,
            template, startMins, meetingDuration;
        // Dom variables
        ...
        for (i = 0; i < todayMeetings.length; i++) {
            ...
            for (j = i + 1; j < todayMeetings.length; j++) {
                ...
                if ((sourceStartTime === compareStartTime) ||
                    (sourceStartTime < compareStartTime && sourceEndTime > compareStartTime) || (sourceStartTime < compareEndTime && sourceEndTime > compareEndTime) || (sourceStartTime > compareStartTime && sourceStartTime < compareEndTime)) {
